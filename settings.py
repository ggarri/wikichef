from os import path
# Django settings for wikichef project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_wikichef',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&x5z!cnj#fc%=2g4%zf__m2!1w-qav3lu06u9d)27=jpp9c851'
